...
declare -A MODEL_CONFIGS=(
    ...
    ["Sd3"]="sd3_example.py /workspace/.cache/huggingface/hub/models--stabilityai--stable-diffusion-3-medium-diffusers 20"
...
PARALLEL_ARGS="--pipefusion_parallel_degree 8"
